	...
	case 'verificar':
		...
		if (isset($fetch))
	    {
			...
			//Determinamos los accesos del usuario
					...
					//Determinamos los accesos del usuario
					in_array(1,$valores)?$_SESSION['Prestamos']=1:$_SESSION['Prestamos']=0;
					in_array(2,$valores)?$_SESSION['Pagos']=1:$_SESSION['Pagos']=0;
					in_array(4,$valores)?$_SESSION['Clientes']=1:$_SESSION['Clientes']=0;
					in_array(5,$valores)?$_SESSION['Usuario']=1:$_SESSION['Usuario']=0;
					in_array(6,$valores)?$_SESSION['Permiso']=1:$_SESSION['Permiso']=0;
